...
import NoNotice from "../images/notice/notice.png";
...
const NotifyModal = () => {
  ...
  const handleDeleteAll = () => {
    ...
    if (
      window.confirm(
        `Bạn có ${newArr.length} thông báo chưa đọc. Bạn có chắc chắn muốn xóa tất cả không?`
      )
    ) {
  ...
  return (
    <div style={{ minWidth: "300px" }}>
      <div className="d-flex justify-content-between align-items-center px-3">
        <h3 style={{ fontSize: "1.2rem" }}>Thông báo</h3>
        {notify.sound ? (
          <i
